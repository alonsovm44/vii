...
static const char *tok_kw[] = {
    "if","else","while","break","do","ask","list","dict","key","keys","at","set","put","arg","paste","len","ord","chr","tonum","tostr","slice","type","time","append","sys","env","exit","ref","ptr","bit","for","in","split","trim","replace","safe","and","or","out","not","addr","stack_alloc",
    /* Type system keywords */
    "i8","i16","i32","i64","u8","u16","u32","u64","f32","f64"
};
static const TokKind kw_kind[] = {
    TOK_IF,TOK_ELSE,TOK_WHILE,TOK_BREAK,TOK_DO,TOK_ASK,TOK_LIST,TOK_DICT,TOK_KEY,TOK_KEYS,TOK_AT,TOK_SET,TOK_PUT,TOK_ARG,TOK_PASTE,TOK_LEN,TOK_ORD,TOK_CHR,TOK_TONUM,TOK_TOSTR,TOK_SLICE,TOK_TYPE,TOK_TIME,TOK_APPEND,TOK_SYS,TOK_ENV,TOK_EXIT,TOK_REF,TOK_PTR,TOK_BIT,TOK_FOR,TOK_IN,TOK_SPLIT,TOK_TRIM,TOK_REPLACE,TOK_SAFE,TOK_AND,TOK_OR,TOK_OUT,TOK_NOT,TOK_ADDR,TOK_STACK_ALLOC,
    /* Type system tokens */
