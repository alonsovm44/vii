...
static const char *tok_kw[] = {
    "if", "else", "while", "break", "do", "ask", "list", "dict", "key", "keys",
    ...
    "trim", "replace", "safe", "and", "or", "out", "not", "addr", "stack_alloc",
    "ent", "uni", "index", "indexes", "nada", "typeset",
    /* Type system keywords */
    "i8", "i16", "i32", "i64", "u8", "u16", "u32", "u64", "f32", "f64"
};
static const TokKind kw_kind[] = {
    TOK_IF, TOK_ELSE, TOK_WHILE, TOK_BREAK, TOK_DO, TOK_ASK, TOK_LIST, TOK_DICT, TOK_KEY, TOK_KEYS,
    ...
    TOK_TRIM, TOK_REPLACE, TOK_SAFE, TOK_AND, TOK_OR, TOK_OUT, TOK_NOT, TOK_ADDR, TOK_STACK_ALLOC,
