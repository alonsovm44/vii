...
static Value* io_func_compile_to_c(Table* parent, int argc, Value** argv) {
  ...
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("#include \"src/vii.h\"")});
...
table_set(env, "i", runtime_binop(41, runtime_var_get(env, "i"), val_num(1)));
  ...
  table_set(env, "declared_vars", val_dict());
  runtime_call(table_get(env, "hoist_vars"), env, 1, (Value*[]){runtime_var_get(env, "prog")});
  table_set(env, "vnames", runtime_keys(runtime_var_get(env, "declared_vars")));
  table_set(env, "i", val_num(0));
  while (val_truthy(runtime_binop(47, runtime_var_get(env, "i"), runtime_len(runtime_var_get(env, "vnames"))))) {
    runtime_binop(41, runtime_binop(41, runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("Value* ")}), runtime_at(runtime_var_get(env, "vnames"), runtime_var_get(env, "i"))), val_str(" = val_none();"));
table_set(env, "i", runtime_binop(41, runtime_var_get(env, "i"), val_num(1)));
  ...
  runtime_call(table_get(env, "emit_stmt"), env, 1, (Value*[]){runtime_var_get(env, "prog")});
