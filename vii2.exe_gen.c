...
static Value* io_func_infer_node_type(Table* parent, int argc, Value** argv) {
  ...
  return runtime_at(runtime_var_get(env, "n"), val_str("type_tag"));
}
...
static Value* io_func_parse_stmt(Table* parent, int argc, Value** argv) {
  ...
  if (val_truthy(runtime_binop(40, runtime_binop(52, runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "TOK_IDENT")), runtime_var_get(env, "text")), val_str("IF")))) {
    return runtime_call(table_get(env, "parse_when_stmt"), env, 1, (Value*[]){runtime_var_get(env, "p")});
  }
...
if (val_truthy(runtime_var_get(env, "already_done"))) {
  return runtime_call(table_get(env, "nd_new"), env, 2, (Value*[]){runtime_var_get(env, "ND_BLOCK"), runtime_var_get(env, "t")});
}
...
val_none();
val_none();
return runtime_call(table_get(env, "parse_program"), env, 1, (Value*[]){runtime_var_get(env, "sub_p")});
  }
...
return runtime_var_get(env, "n");
  ...
  if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "TOK_BREAK")))) {
    val_print(runtime_call(table_get(env, "advance"), env, 1, (Value*[]){runtime_var_get(env, "p")})); printf("\n");
return runtime_call(table_get(env, "nd_new"), env, 2, (Value*[]){runtime_var_get(env, "ND_BREAK"), runtime_var_get(env, "t")});
  }
  if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "TOK_SKIP")))) {
    val_print(runtime_call(table_get(env, "advance"), env, 1, (Value*[]){runtime_var_get(env, "p")})); printf("\n");
return runtime_call(table_get(env, "nd_new"), env, 2, (Value*[]){runtime_var_get(env, "ND_SKIP"), runtime_var_get(env, "t")});
  }
...
static Value* io_func_val_print(Table* parent, int argc, Value** argv) {
  ...
  if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "VAL_NUM")))) {
    return runtime_tostr(runtime_at(runtime_var_get(env, "v"), val_str("num")));
  } else {
    if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "VAL_STR")))) {
      return runtime_at(runtime_var_get(env, "v"), val_str("str"));
    } else {
...
return runtime_binop(41, runtime_var_get(env, "res_str"), val_str("]"));
          } else {
...
static Value* io_func_val_truthy(Table* parent, int argc, Value** argv) {
  ...
  table_set(env, "k", runtime_at(runtime_var_get(env, "v"), val_str("kind")));
  if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "VAL_NUM")))) {
    return runtime_binop(51, runtime_at(runtime_var_get(env, "v"), val_str("num")), val_num(0));
  } else {
    if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "VAL_STR")))) {
      return runtime_binop(48, runtime_len(runtime_at(runtime_var_get(env, "v"), val_str("str"))), val_num(0));
    } else {
      if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "VAL_LIST")))) {
        return runtime_binop(48, runtime_len(runtime_at(runtime_var_get(env, "v"), val_str("items"))), val_num(0));
      } else {
        if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "VAL_BIT")))) {
          return runtime_at(runtime_var_get(env, "v"), val_str("num"));
        }
      }
    }
  }
...
if (val_truthy(runtime_binop(51, runtime_type(runtime_var_get(env, "val")), val_str("none")))) {
  return runtime_var_get(env, "val");
}
...
runtime_put(val_str(""), runtime_var_get(env, "msg"), 0);
  ...
  table_set(env, "k", runtime_at(runtime_var_get(env, "n"), val_str("kind")));
  if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "ND_NUM")))) {
    return runtime_call(table_get(env, "val_num"), env, 1, (Value*[]){runtime_at(runtime_var_get(env, "n"), val_str("num"))});
  }
  if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "ND_STR")))) {
    return runtime_call(table_get(env, "val_str"), env, 1, (Value*[]){runtime_at(runtime_var_get(env, "n"), val_str("str"))});
  }
...
return runtime_call(table_get(env, "val_num"), env, 1, (Value*[]){val_num(0 - (runtime_at(runtime_var_get(env, "v"), val_str("num")))->num)});
  }
  if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "ND_VAR")))) {
...
if (val_truthy(runtime_binop(40, runtime_at(runtime_var_get(env, "res"), val_str("kind")), runtime_var_get(env, "VAL_OUT")))) {
  return runtime_at(runtime_var_get(env, "res"), val_str("inner"));
}
return runtime_var_get(env, "res");
}
...
return runtime_var_get(env, "res");
  ...
  if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "ND_SKIP")))) {
    return runtime_var_get(env, "val_skip");
  }
...
if (val_truthy(runtime_binop(40, runtime_var_get(env, "op"), runtime_var_get(env, "TOK_AND")))) {
  ...
  return runtime_call(table_get(env, "val_num"), env, 1, (Value*[]){val_num(0)});
}
return runtime_call(table_get(env, "eval"), env, 2, (Value*[]){runtime_at(runtime_var_get(env, "n"), val_str("right")), runtime_var_get(env, "env_")});
}
if (val_truthy(runtime_binop(40, runtime_var_get(env, "op"), runtime_var_get(env, "TOK_OR")))) {
  ...
  return runtime_call(table_get(env, "val_num"), env, 1, (Value*[]){val_num(1)});
}
return runtime_call(table_get(env, "eval"), env, 2, (Value*[]){runtime_at(runtime_var_get(env, "n"), val_str("right")), runtime_var_get(env, "env_")});
}
...
if (val_truthy(runtime_binop(40, runtime_var_get(env, "op"), runtime_var_get(env, "TOK_PLUS")))) {
  return runtime_call(table_get(env, "val_num"), env, 1, (Value*[]){runtime_binop(41, runtime_var_get(env, "lv"), runtime_var_get(env, "rv"))});
}
if (val_truthy(runtime_binop(40, runtime_var_get(env, "op"), runtime_var_get(env, "TOK_MINUS")))) {
  return runtime_call(table_get(env, "val_num"), env, 1, (Value*[]){runtime_binop(42, runtime_var_get(env, "lv"), runtime_var_get(env, "rv"))});
}
if (val_truthy(runtime_binop(40, runtime_var_get(env, "op"), runtime_var_get(env, "TOK_STAR")))) {
  return runtime_call(table_get(env, "val_num"), env, 1, (Value*[]){runtime_binop(43, runtime_var_get(env, "lv"), runtime_var_get(env, "rv"))});
}
if (val_truthy(runtime_binop(40, runtime_var_get(env, "op"), runtime_var_get(env, "TOK_SLASH")))) {
  return runtime_call(table_get(env, "val_num"), env, 1, (Value*[]){runtime_binop(44, runtime_var_get(env, "lv"), runtime_var_get(env, "rv"))});
}
if (val_truthy(runtime_binop(40, runtime_var_get(env, "op"), runtime_var_get(env, "TOK_LT")))) {
  return runtime_call(table_get(env, "val_bit"), env, 1, (Value*[]){runtime_binop(47, runtime_var_get(env, "lv"), runtime_var_get(env, "rv"))});
}
if (val_truthy(runtime_binop(40, runtime_var_get(env, "op"), runtime_var_get(env, "TOK_GT")))) {
  return runtime_call(table_get(env, "val_bit"), env, 1, (Value*[]){runtime_binop(48, runtime_var_get(env, "lv"), runtime_var_get(env, "rv"))});
}
if (val_truthy(runtime_binop(40, runtime_var_get(env, "op"), runtime_var_get(env, "TOK_LTE")))) {
  return runtime_call(table_get(env, "val_bit"), env, 1, (Value*[]){runtime_binop(49, runtime_var_get(env, "lv"), runtime_var_get(env, "rv"))});
}
if (val_truthy(runtime_binop(40, runtime_var_get(env, "op"), runtime_var_get(env, "TOK_GTE")))) {
  return runtime_call(table_get(env, "val_bit"), env, 1, (Value*[]){runtime_binop(50, runtime_var_get(env, "lv"), runtime_var_get(env, "rv"))});
}
if (val_truthy(runtime_binop(40, runtime_var_get(env, "op"), runtime_var_get(env, "TOK_EQEQ")))) {
  return runtime_call(table_get(env, "val_bit"), env, 1, (Value*[]){runtime_binop(40, runtime_var_get(env, "lv"), runtime_var_get(env, "rv"))});
}
if (val_truthy(runtime_binop(40, runtime_var_get(env, "op"), runtime_var_get(env, "TOK_NE")))) {
  return runtime_call(table_get(env, "val_bit"), env, 1, (Value*[]){runtime_binop(51, runtime_var_get(env, "lv"), runtime_var_get(env, "rv"))});
}
}
...
return runtime_call(table_get(env, "val_str"), env, 1, (Value*[]){runtime_binop(41, runtime_var_get(env, "ls"), runtime_var_get(env, "rs"))});
}
...
table_set(env, "rs", runtime_at(runtime_var_get(env, "r"), val_str("str")));
if (val_truthy(runtime_binop(40, runtime_var_get(env, "op"), runtime_var_get(env, "TOK_LT")))) {
  return runtime_call(table_get(env, "val_bit"), env, 1, (Value*[]){runtime_binop(47, runtime_var_get(env, "ls"), runtime_var_get(env, "rs"))});
}
if (val_truthy(runtime_binop(40, runtime_var_get(env, "op"), runtime_var_get(env, "TOK_GT")))) {
  return runtime_call(table_get(env, "val_bit"), env, 1, (Value*[]){runtime_binop(48, runtime_var_get(env, "ls"), runtime_var_get(env, "rs"))});
}
if (val_truthy(runtime_binop(40, runtime_var_get(env, "op"), runtime_var_get(env, "TOK_LTE")))) {
  return runtime_call(table_get(env, "val_bit"), env, 1, (Value*[]){runtime_binop(49, runtime_var_get(env, "ls"), runtime_var_get(env, "rs"))});
}
if (val_truthy(runtime_binop(40, runtime_var_get(env, "op"), runtime_var_get(env, "TOK_GTE")))) {
  return runtime_call(table_get(env, "val_bit"), env, 1, (Value*[]){runtime_binop(50, runtime_var_get(env, "ls"), runtime_var_get(env, "rs"))});
}
if (val_truthy(runtime_binop(40, runtime_var_get(env, "op"), runtime_var_get(env, "TOK_EQEQ")))) {
  return runtime_call(table_get(env, "val_bit"), env, 1, (Value*[]){runtime_binop(40, runtime_var_get(env, "ls"), runtime_var_get(env, "rs"))});
}
if (val_truthy(runtime_binop(40, runtime_var_get(env, "op"), runtime_var_get(env, "TOK_NE")))) {
  return runtime_call(table_get(env, "val_bit"), env, 1, (Value*[]){runtime_binop(51, runtime_var_get(env, "ls"), runtime_var_get(env, "rs"))});
}
}
}
return runtime_var_get(env, "val_none");
...
if (val_truthy(runtime_call(table_get(env, "val_truthy"), env, 1, (Value*[]){runtime_var_get(env, "cond")}))) {
  return runtime_call(table_get(env, "eval_block"), env, 2, (Value*[]){runtime_var_get(env, "n"), runtime_var_get(env, "env_")});
} else {
...
if (val_truthy(runtime_binop(40, runtime_at(runtime_var_get(env, "right"), val_str("kind")), runtime_var_get(env, "ND_BLOCK")))) {
  return runtime_call(table_get(env, "eval_block"), env, 2, (Value*[]){runtime_var_get(env, "right"), runtime_var_get(env, "env_")});
}
return runtime_call(table_get(env, "eval"), env, 2, (Value*[]){runtime_var_get(env, "right"), runtime_var_get(env, "env_")});
  }
}
return runtime_var_get(env, "val_none");
  }
...
return runtime_var_get(env, "res");
  ...
  if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "ND_TRIM")))) {
    table_set(env, "v", runtime_call(table_get(env, "val_unwrap"), env, 1, (Value*[]){runtime_call(table_get(env, "eval"), env, 2, (Value*[]){runtime_at(runtime_var_get(env, "n"), val_str("left")), runtime_var_get(env, "env_")})}));
return runtime_call(table_get(env, "val_str"), env, 1, (Value*[]){runtime_trim(runtime_at(runtime_var_get(env, "v"), val_str("str")))});
  }
...
return runtime_call(table_get(env, "val_str"), env, 1, (Value*[]){val_none()});
  }
  if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "ND_SAFE")))) {
    return runtime_call(table_get(env, "eval"), env, 2, (Value*[]){runtime_at(runtime_var_get(env, "n"), val_str("left")), runtime_var_get(env, "env_")});
  }
  if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "ND_OUT")))) {
    return runtime_call(table_get(env, "val_out"), env, 1, (Value*[]){runtime_call(table_get(env, "eval"), env, 2, (Value*[]){runtime_at(runtime_var_get(env, "n"), val_str("left")), runtime_var_get(env, "env_")})});
  }
  if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "ND_BREAK")))) {
    return runtime_var_get(env, "val_break");
  }
...
val_print(runtime_var_get(env, "v_print")); printf("\n");
  ...
  if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "ND_ASK")))) {
    return runtime_ask(runtime_var_get(env, "val_str"));
  }
...
return runtime_call(table_get(env, "val_str"), env, 1, (Value*[]){runtime_var_get(env, "content")});
  }
...
if (val_truthy(runtime_binop(40, runtime_at(runtime_var_get(env, "v"), val_str("kind")), runtime_var_get(env, "VAL_STR")))) {
  return runtime_call(table_get(env, "val_num"), env, 1, (Value*[]){runtime_len(runtime_at(runtime_var_get(env, "v"), val_str("str")))});
}
if (val_truthy(runtime_binop(40, runtime_at(runtime_var_get(env, "v"), val_str("kind")), runtime_var_get(env, "VAL_LIST")))) {
  return runtime_call(table_get(env, "val_num"), env, 1, (Value*[]){runtime_len(runtime_at(runtime_var_get(env, "v"), val_str("items")))});
}
return runtime_call(table_get(env, "val_num"), env, 1, (Value*[]){val_num(0)});
  }
...
if (val_truthy(runtime_binop(40, runtime_at(runtime_var_get(env, "target"), val_str("kind")), runtime_var_get(env, "VAL_LIST")))) {
  return runtime_at(runtime_at(runtime_var_get(env, "target"), val_str("items")), runtime_at(runtime_var_get(env, "idx"), val_str("num")));
}
if (val_truthy(runtime_binop(40, runtime_at(runtime_var_get(env, "target"), val_str("kind")), runtime_var_get(env, "VAL_DICT")))) {
...
if (val_truthy(runtime_binop(40, runtime_at(runtime_var_get(env, "target"), val_str("kind")), runtime_var_get(env, "VAL_STR")))) {
  return runtime_call(table_get(env, "val_str"), env, 1, (Value*[]){runtime_slice(runtime_at(runtime_var_get(env, "target"), val_str("str")), runtime_var_get(env, "s"), runtime_var_get(env, "e"))});
}
if (val_truthy(runtime_binop(40, runtime_at(runtime_var_get(env, "target"), val_str("kind")), runtime_var_get(env, "VAL_LIST")))) {
  table_set(env, "res", val_none());
val_none();
...
return runtime_call(table_get(env, "val_num"), env, 1, (Value*[]){runtime_sys(runtime_at(runtime_var_get(env, "cmd"), val_str("str")))});
  }
...
return runtime_call(table_get(env, "val_str"), env, 1, (Value*[]){runtime_call(table_get(env, "env_"), env, 1, (Value*[]){runtime_at(runtime_var_get(env, "var"), val_str("str"))})});
  }
  if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "ND_ARG")))) {
    return runtime_call(table_get(env, "table_get"), env, 2, (Value*[]){runtime_var_get(env, "env_"), val_str("arg")});
  }
  if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "ND_TIME")))) {
    return runtime_call(table_get(env, "val_num"), env, 1, (Value*[]){val_num((double)time(NULL))});
  }
...
if (val_truthy(runtime_binop(40, runtime_var_get(env, "tk"), runtime_var_get(env, "VAL_NUM")))) {
  return runtime_call(table_get(env, "val_str"), env, 1, (Value*[]){val_str("num")});
}
if (val_truthy(runtime_binop(40, runtime_var_get(env, "tk"), runtime_var_get(env, "VAL_STR")))) {
  return runtime_call(table_get(env, "val_str"), env, 1, (Value*[]){val_str("str")});
}
if (val_truthy(runtime_binop(40, runtime_var_get(env, "tk"), runtime_var_get(env, "VAL_LIST")))) {
  return runtime_call(table_get(env, "val_str"), env, 1, (Value*[]){val_str("list")});
}
if (val_truthy(runtime_binop(40, runtime_var_get(env, "tk"), runtime_var_get(env, "VAL_DICT")))) {
  return runtime_call(table_get(env, "val_str"), env, 1, (Value*[]){val_str("dict")});
}
if (val_truthy(runtime_binop(40, runtime_var_get(env, "tk"), runtime_var_get(env, "VAL_BIT")))) {
  return runtime_call(table_get(env, "val_str"), env, 1, (Value*[]){val_str("bit")});
}
return runtime_call(table_get(env, "val_str"), env, 1, (Value*[]){val_str("none")});
  }
...
static Value* io_func_emit_expr(Table* parent, int argc, Value** argv) {
  ...
  table_set(env, "k", runtime_at(runtime_var_get(env, "n"), val_str("kind")));
  if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "ND_NUM")))) {
    return runtime_binop(41, runtime_str_concat(runtime_tostr(val_str("val_num("))->str, runtime_tostr(runtime_tostr(runtime_at(runtime_var_get(env, "n"), val_str("num"))))->str), val_str(")"));
  }
  if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "ND_STR")))) {
    return runtime_binop(41, runtime_str_concat(runtime_tostr(val_str("val_str(\""))->str, runtime_tostr(runtime_at(runtime_var_get(env, "n"), val_str("str")))->str), val_str("\")"));
  }
  if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "ND_VAR")))) {
    return runtime_at(runtime_var_get(env, "n"), val_str("name"));
  }
  if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "ND_NOT")))) {
    return runtime_binop(41, runtime_str_concat(runtime_tostr(val_str("val_not("))->str, runtime_tostr(runtime_call(table_get(env, "emit_expr"), env, 1, (Value*[]){runtime_at(runtime_var_get(env, "n"), val_str("left"))}))->str), val_str(")"));
  }
  if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "ND_LEN")))) {
    return runtime_binop(41, runtime_str_concat(runtime_tostr(val_str("val_len("))->str, runtime_tostr(runtime_call(table_get(env, "emit_expr"), env, 1, (Value*[]){runtime_at(runtime_var_get(env, "n"), val_str("left"))}))->str), val_str(")"));
  }
  if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "ND_TONUM")))) {
    return runtime_binop(41, runtime_str_concat(runtime_tostr(val_str("val_tonum("))->str, runtime_tostr(runtime_call(table_get(env, "emit_expr"), env, 1, (Value*[]){runtime_at(runtime_var_get(env, "n"), val_str("left"))}))->str), val_str(")"));
  }
  if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "ND_TOSTR")))) {
    return runtime_binop(41, runtime_str_concat(runtime_tostr(val_str("val_tostr("))->str, runtime_tostr(runtime_call(table_get(env, "emit_expr"), env, 1, (Value*[]){runtime_at(runtime_var_get(env, "n"), val_str("left"))}))->str), val_str(")"));
  }
  if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "ND_TYPE")))) {
    return runtime_binop(41, runtime_str_concat(runtime_tostr(val_str("val_type("))->str, runtime_tostr(runtime_call(table_get(env, "emit_expr"), env, 1, (Value*[]){runtime_at(runtime_var_get(env, "n"), val_str("left"))}))->str), val_str(")"));
  }
  if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "ND_LIST")))) {
    return val_str("val_list()");
  }
  if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "ND_DICT")))) {
    return val_str("val_dict()");
  }
  if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "ND_AT")))) {
    return runtime_binop(41, runtime_binop(41, runtime_binop(41, runtime_str_concat(runtime_tostr(val_str("val_at("))->str, runtime_tostr(runtime_call(table_get(env, "emit_expr"), env, 1, (Value*[]){runtime_at(runtime_var_get(env, "n"), val_str("left"))}))->str), val_str(", ")), runtime_call(table_get(env, "emit_expr"), env, 1, (Value*[]){runtime_at(runtime_var_get(env, "n"), val_str("right"))})), val_str(")"));
  }
  if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "ND_SLICE")))) {
    table_set(env, "body", runtime_at(runtime_var_get(env, "n"), val_str("body")));
return runtime_binop(41, runtime_binop(41, runtime_binop(41, runtime_binop(41, runtime_binop(41, runtime_str_concat(runtime_tostr(val_str("val_slice("))->str, runtime_tostr(runtime_call(table_get(env, "emit_expr"), env, 1, (Value*[]){runtime_at(runtime_var_get(env, "n"), val_str("left"))}))->str), val_str(", ")), runtime_call(table_get(env, "emit_expr"), env, 1, (Value*[]){runtime_at(runtime_var_get(env, "body"), val_num(0))})), val_str(", ")), runtime_call(table_get(env, "emit_expr"), env, 1, (Value*[]){runtime_at(runtime_var_get(env, "body"), val_num(1))})), val_str(")"));
  }
  if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "ND_BINOP")))) {
...
table_set(env, "op", runtime_at(runtime_var_get(env, "n"), val_str("op")));
return runtime_binop(41, runtime_binop(41, runtime_binop(41, runtime_binop(41, runtime_binop(41, runtime_str_concat(runtime_tostr(val_str("runtime_binop("))->str, runtime_tostr(runtime_var_get(env, "l"))->str), val_str(", ")), runtime_tostr(runtime_var_get(env, "op"))), val_str(", ")), runtime_var_get(env, "r")), val_str(")"));
  }
  if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "ND_CALL")))) {
...
return runtime_binop(41, runtime_var_get(env, "s"), val_str(")"));
  }
...
static Value* io_func_main(Table* parent, int argc, Value** argv) {
  ...
  table_set(env, "input_path", runtime_tostr(val_str("none")));
  table_set(env, "output_name", runtime_tostr(val_str("none")));
...
if (val_truthy(runtime_binop(40, runtime_var_get(env, "current_arg"), val_str("--debug")))) {
  ...
  if (val_truthy(runtime_binop(40, runtime_var_get(env, "current_arg"), val_str("--bootdebug")))) {
    ...
    if (val_truthy(runtime_binop(40, runtime_var_get(env, "current_arg"), val_str("-o")))) {
      if (val_truthy(runtime_binop(47, runtime_binop(41, runtime_var_get(env, "i"), val_num(1)), runtime_var_get(env, "argc")))) {
  table_set(env, "output_name", runtime_at(io_args, runtime_binop(41, runtime_var_get(env, "i"), val_num(1))));
table_set(env, "i", runtime_binop(41, runtime_var_get(env, "i"), val_num(1)));
} else {
...
exit((int)(val_num(1))->num);
      ...
      if (val_truthy(runtime_binop(40, runtime_binop(53, runtime_binop(40, runtime_var_get(env, "current_arg"), val_str("-k")), runtime_var_get(env, "current_arg")), val_str("--keep")))) {
        table_set(env, "keep_c", val_num(1));
      } else {
        if (val_truthy(runtime_binop(40, runtime_binop(53, runtime_binop(40, runtime_var_get(env, "current_arg"), val_str("-D")), runtime_var_get(env, "current_arg")), val_str("--define")))) {
          if (val_truthy(runtime_binop(47, runtime_binop(41, runtime_var_get(env, "i"), val_num(1)), runtime_var_get(env, "argc")))) {
  val_print(runtime_at(runtime_call(table_get(env, "add_define"), env, 1, (Value*[]){io_args}), runtime_binop(41, runtime_var_get(env, "i"), val_num(1)))); printf("\n");
table_set(env, "i", runtime_binop(41, runtime_var_get(env, "i"), val_num(1)));
} else {
...
exit((int)(val_num(0))->num);
            ...
            if (val_truthy(runtime_binop(40, runtime_var_get(env, "current_arg"), val_str("--help")))) {
              ...
              if (val_truthy(runtime_call(table_get(env, "str_contains"), env, 2, (Value*[]){runtime_var_get(env, "current_arg"), val_str("main.vii")}))) {
                ...
                if (val_truthy(runtime_binop(40, runtime_binop(53, runtime_binop(40, runtime_var_get(env, "current_arg"), val_str("vii")), runtime_var_get(env, "current_arg")), val_str("vii.exe")))) {
                  val_print(val_str("")); printf("\n");
                } else {
                  if (val_truthy(runtime_binop(40, runtime_at(runtime_var_get(env, "current_arg"), val_num(0)), val_str("-")))) {
...
table_set(env, "i", runtime_binop(41, runtime_var_get(env, "i"), val_num(1)));
  ...
  if (val_truthy(runtime_binop(40, runtime_binop(52, runtime_binop(40, runtime_call(table_get(env, "str_contains"), env, 2, (Value*[]){runtime_var_get(env, "output_name"), val_str(".exe")}), val_num(0)), runtime_call(table_get(env, "str_contains"), env, 2, (Value*[]){runtime_var_get(env, "output_name"), val_str(".EXE")})), val_num(0)))) {
...
exit((int)(val_num(0))->num);
  ...
  table_set(env, "global", val_none());
  val_none();
  val_none();
  table_set(env, "res", runtime_call(table_get(env, "val_unwrap"), env, 1, (Value*[]){runtime_call(table_get(env, "eval"), env, 2, (Value*[]){runtime_var_get(env, "prog"), runtime_var_get(env, "global")})}));
