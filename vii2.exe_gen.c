...
static Value* io_func_report_error(Table* parent, int argc, Value** argv) {
  ...
  runtime_binop(41, runtime_binop(41, runtime_binop(41, runtime_binop(41, runtime_str_concat(runtime_tostr(val_str("x1b[1;31mError in "))->str, runtime_tostr(runtime_var_get(env, "filename"))->str), val_str(" on line ")), runtime_tostr(runtime_var_get(env, "line"))), val_str(": x1b[0m")), runtime_var_get(env, "fmt"));
...
table_set(env, "end", runtime_binop(41, runtime_var_get(env, "end"), val_num(1)));
  ...
  runtime_binop(41, runtime_binop(41, runtime_str_concat(runtime_tostr(val_str(" "))->str, runtime_tostr(runtime_var_get(env, "lstr"))->str), val_str(" | ")), runtime_slice(runtime_var_get(env, "src"), runtime_var_get(env, "start"), runtime_var_get(env, "end")));
...
table_set(env, "i", runtime_binop(41, runtime_var_get(env, "i"), val_num(1)));
  ...
  runtime_binop(41, runtime_var_get(env, "caret_line"), val_str("x1b[1;32m^x1b[0m"));
...
if (val_truthy(runtime_binop(51, runtime_binop(52, runtime_binop(52, runtime_var_get(env, "boot_debug"), runtime_binop(40, runtime_binop(45, runtime_var_get(env, "t_count"), val_num(1000)), val_num(0))), runtime_var_get(env, "t_count")), runtime_var_get(env, "last_heartbeat")))) {
  runtime_binop(41, runtime_str_concat(runtime_tostr(val_str("Lexer heartbeat: "))->str, runtime_tostr(runtime_tostr(runtime_var_get(env, "t_count")))->str), val_str(" tokens generated..."));
...
if (val_truthy(runtime_binop(40, runtime_var_get(env, "op_kind"), val_num(0 - (val_num(1))->num)))) {
  runtime_call(table_get(env, "report_error"), env, 5, (Value*[]){runtime_at(runtime_var_get(env, "lexer_ctx"), val_str("filename")), runtime_var_get(env, "src"), runtime_var_get(env, "pos"), runtime_var_get(env, "line"), runtime_str_concat(runtime_tostr(val_str("Unexpected character: "))->str, runtime_tostr(runtime_var_get(env, "char"))->str)});
table_set(env, "pos", runtime_binop(41, runtime_var_get(env, "pos"), val_num(1)));
}
            }
          }
...
static Value* io_func_track_constant(Table* parent, int argc, Value** argv) {
  ...
  runtime_binop(41, runtime_binop(41, runtime_binop(41, runtime_binop(41, runtime_binop(41, runtime_str_concat(runtime_tostr(val_str("Error in "))->str, runtime_tostr(runtime_at(runtime_var_get(env, "p"), val_str("filename")))->str), val_str(" on line ")), runtime_tostr(runtime_var_get(env, "line"))), val_str(": cannot reassign constant '")), runtime_var_get(env, "name")), val_str("'"));
exit((int)(val_num(1))->num);
}
table_set(env, "i", runtime_binop(41, runtime_var_get(env, "i"), val_num(1)));
  }
...
static Value* io_func_expect(Table* parent, int argc, Value** argv) {
  ...
  if (val_truthy(runtime_binop(51, runtime_at(runtime_var_get(env, "t"), val_str("kind")), runtime_var_get(env, "kind")))) {
    runtime_binop(41, runtime_binop(41, runtime_binop(41, runtime_binop(41, runtime_binop(41, runtime_binop(41, runtime_str_concat(runtime_tostr(val_str("Error in "))->str, runtime_tostr(runtime_at(runtime_var_get(env, "p"), val_str("filename")))->str), val_str(" on line ")), runtime_tostr(runtime_at(runtime_var_get(env, "t"), val_str("line")))), val_str(": expected token kind ")), runtime_tostr(runtime_var_get(env, "kind"))), val_str(", got ")), runtime_tostr(runtime_at(runtime_var_get(env, "t"), val_str("kind"))));
exit((int)(val_num(1))->num);
  }
...
runtime_var_get(env, "n");
            ...
            if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "TOK_ASK")))) {
              runtime_call(table_get(env, "advance"), env, 1, (Value*[]){runtime_var_get(env, "p")});
runtime_call(table_get(env, "nd_new"), env, 2, (Value*[]){runtime_var_get(env, "ND_ASK"), runtime_var_get(env, "t")});
            } else {
              if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "TOK_ARG")))) {
                runtime_call(table_get(env, "advance"), env, 1, (Value*[]){runtime_var_get(env, "p")});
runtime_call(table_get(env, "nd_new"), env, 2, (Value*[]){runtime_var_get(env, "ND_ARG"), runtime_var_get(env, "t")});
              } else {
...
runtime_var_get(env, "n");
                                        ...
                                        if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "TOK_TIME")))) {
                                          runtime_call(table_get(env, "advance"), env, 1, (Value*[]){runtime_var_get(env, "p")});
runtime_call(table_get(env, "nd_new"), env, 2, (Value*[]){runtime_var_get(env, "ND_TIME"), runtime_var_get(env, "t")});
                                        } else {
...
runtime_var_get(env, "n");
                                                  ...
                                                  if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "TOK_LIST")))) {
                                                    runtime_call(table_get(env, "advance"), env, 1, (Value*[]){runtime_var_get(env, "p")});
runtime_call(table_get(env, "nd_new"), env, 2, (Value*[]){runtime_var_get(env, "ND_LIST"), runtime_var_get(env, "t")});
                                                  } else {
                                                    if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "TOK_DICT")))) {
                                                      runtime_call(table_get(env, "advance"), env, 1, (Value*[]){runtime_var_get(env, "p")});
runtime_call(table_get(env, "nd_new"), env, 2, (Value*[]){runtime_var_get(env, "ND_DICT"), runtime_var_get(env, "t")});
                                                    } else {
...
if (val_truthy(runtime_call(table_get(env, "is_all_caps"), env, 1, (Value*[]){runtime_var_get(env, "param_name")}))) {
  runtime_call(table_get(env, "track_constant"), env, 4, (Value*[]){runtime_var_get(env, "p"), runtime_var_get(env, "param_name"), runtime_at(runtime_var_get(env, "t"), val_str("pos")), runtime_at(runtime_var_get(env, "t"), val_str("line"))});
}
if (val_truthy(runtime_binop(40, runtime_at(runtime_call(table_get(env, "peek"), env, 1, (Value*[]){runtime_var_get(env, "p")}), val_str("kind")), runtime_var_get(env, "TOK_ARROW")))) {
  runtime_call(table_get(env, "advance"), env, 1, (Value*[]){runtime_var_get(env, "p")});
...
runtime_call(table_get(env, "nd_push"), env, 2, (Value*[]){runtime_var_get(env, "n"), runtime_var_get(env, "param")});
}
runtime_call(table_get(env, "skip_newlines"), env, 1, (Value*[]){runtime_var_get(env, "p")});
runtime_call(table_get(env, "expect"), env, 2, (Value*[]){runtime_var_get(env, "p"), runtime_var_get(env, "TOK_INDENT")});
...
if (val_truthy(runtime_binop(51, runtime_binop(52, runtime_binop(51, runtime_var_get(env, "actual"), val_str("unknown")), runtime_var_get(env, "actual")), runtime_var_get(env, "expected")))) {
  runtime_binop(41, runtime_binop(41, runtime_binop(41, runtime_binop(41, runtime_binop(41, runtime_binop(41, runtime_binop(41, runtime_binop(41, runtime_binop(41, runtime_str_concat(runtime_tostr(val_str("Error in "))->str, runtime_tostr(runtime_at(runtime_var_get(env, "p"), val_str("filename")))->str), val_str(" on line ")), runtime_tostr(runtime_at(runtime_var_get(env, "do_tok"), val_str("line")))), val_str(": return type mismatch in function '")), runtime_at(runtime_var_get(env, "n"), val_str("name"))), val_str("': expected '")), runtime_var_get(env, "expected")), val_str("', found '")), runtime_var_get(env, "actual")), val_str("'"));
exit((int)(val_num(1))->num);
}
}
}
...
runtime_key(runtime_var_get(env, "n"), val_str("left"), runtime_var_get(env, "expr"));
runtime_call(table_get(env, "nd_push"), env, 2, (Value*[]){runtime_var_get(env, "n"), runtime_call(table_get(env, "parse_primary"), env, 1, (Value*[]){runtime_var_get(env, "p")})});
runtime_call(table_get(env, "nd_push"), env, 2, (Value*[]){runtime_var_get(env, "n"), runtime_call(table_get(env, "parse_expr"), env, 1, (Value*[]){runtime_var_get(env, "p")})});
table_set(env, "expr", runtime_var_get(env, "n"));
  } else {
...
runtime_key(runtime_var_get(env, "n"), val_str("left"), runtime_var_get(env, "expr"));
runtime_call(table_get(env, "nd_push"), env, 2, (Value*[]){runtime_var_get(env, "n"), runtime_call(table_get(env, "parse_postfix"), env, 1, (Value*[]){runtime_var_get(env, "p")})});
runtime_call(table_get(env, "nd_push"), env, 2, (Value*[]){runtime_var_get(env, "n"), runtime_call(table_get(env, "parse_postfix"), env, 1, (Value*[]){runtime_var_get(env, "p")})});
table_set(env, "expr", runtime_var_get(env, "n"));
    } else {
...
if (val_truthy(runtime_call(table_get(env, "is_all_caps"), env, 1, (Value*[]){runtime_var_get(env, "name")}))) {
  runtime_call(table_get(env, "track_constant"), env, 4, (Value*[]){runtime_var_get(env, "p"), runtime_var_get(env, "name"), runtime_at(runtime_var_get(env, "t"), val_str("pos")), runtime_at(runtime_var_get(env, "t"), val_str("line"))});
}
}
if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "TOK_IDENT")))) {
...
runtime_call(table_get(env, "skip_block_body"), env, 1, (Value*[]){runtime_var_get(env, "p")});
runtime_call(table_get(env, "expect"), env, 2, (Value*[]){runtime_var_get(env, "p"), runtime_var_get(env, "TOK_DEDENT")});
  }
...
if (val_truthy(runtime_binop(51, runtime_at(runtime_var_get(env, "t"), val_str("kind")), runtime_var_get(env, "TOK_STR")))) {
  runtime_binop(41, runtime_binop(41, runtime_binop(41, runtime_str_concat(runtime_tostr(val_str("Error in "))->str, runtime_tostr(runtime_at(runtime_var_get(env, "p"), val_str("filename")))->str), val_str(" on line ")), runtime_tostr(runtime_at(runtime_var_get(env, "t"), val_str("line")))), val_str(": paste requires a string filename"));
exit((int)(val_num(1))->num);
}
...
if (val_truthy(runtime_at(runtime_var_get(env, "p"), val_str("boot_debug")))) {
  runtime_binop(41, runtime_binop(41, runtime_binop(41, runtime_str_concat(runtime_tostr(val_str("Paste trace: inclusion of '"))->str, runtime_tostr(runtime_var_get(env, "filename"))->str), val_str("' from '")), runtime_at(runtime_var_get(env, "p"), val_str("filename"))), val_str("'"));
}
...
runtime_key(runtime_var_get(env, "n"), val_str("name"), runtime_at(runtime_call(table_get(env, "advance"), env, 1, (Value*[]){runtime_var_get(env, "p")}), val_str("text")));
runtime_call(table_get(env, "expect"), env, 2, (Value*[]){runtime_var_get(env, "p"), runtime_var_get(env, "TOK_IN")});
runtime_key(runtime_var_get(env, "n"), val_str("left"), runtime_call(table_get(env, "parse_expr"), env, 1, (Value*[]){runtime_var_get(env, "p")}));
runtime_call(table_get(env, "skip_newlines"), env, 1, (Value*[]){runtime_var_get(env, "p")});
runtime_call(table_get(env, "expect"), env, 2, (Value*[]){runtime_var_get(env, "p"), runtime_var_get(env, "TOK_INDENT")});
runtime_call(table_get(env, "nd_push"), env, 2, (Value*[]){runtime_var_get(env, "n"), runtime_call(table_get(env, "parse_block"), env, 2, (Value*[]){runtime_var_get(env, "p"), val_num(0)})});
runtime_call(table_get(env, "expect"), env, 2, (Value*[]){runtime_var_get(env, "p"), runtime_var_get(env, "TOK_DEDENT")});
return val_out(runtime_var_get(env, "n"));
  }
...
return val_out(runtime_var_get(env, "n"));
  ...
  if (val_truthy(runtime_binop(51, runtime_binop(52, runtime_binop(51, runtime_binop(52, runtime_binop(51, runtime_binop(52, runtime_binop(51, runtime_binop(52, runtime_binop(51, runtime_binop(52, runtime_binop(51, runtime_binop(52, runtime_binop(51, runtime_binop(52, runtime_binop(51, runtime_binop(52, runtime_binop(51, runtime_binop(52, runtime_binop(51, runtime_binop(52, runtime_binop(51, runtime_binop(52, runtime_binop(40, runtime_at(runtime_var_get(env, "p"), val_str("in_func")), val_num(0)), runtime_var_get(env, "ek")), runtime_var_get(env, "ND_ASSIGN")), runtime_var_get(env, "ek")), runtime_var_get(env, "ND_DO")), runtime_var_get(env, "ek")), runtime_var_get(env, "ND_SET")), runtime_var_get(env, "ek")), runtime_var_get(env, "ND_KEY")), runtime_var_get(env, "ek")), runtime_var_get(env, "ND_PUT")), runtime_var_get(env, "ek")), runtime_var_get(env, "ND_EXIT")), runtime_var_get(env, "ek")), runtime_var_get(env, "ND_OUT")), runtime_var_get(env, "ek")), runtime_var_get(env, "ND_BLOCK")), runtime_var_get(env, "ek")), runtime_var_get(env, "ND_IF")), runtime_var_get(env, "ek")), runtime_var_get(env, "ND_WHILE")), runtime_var_get(env, "ek")), runtime_var_get(env, "ND_FOR")))) {
...
runtime_call(table_get(env, "nd_push"), env, 2, (Value*[]){runtime_var_get(env, "block"), runtime_var_get(env, "stmt")});
runtime_call(table_get(env, "skip_newlines"), env, 1, (Value*[]){runtime_var_get(env, "p")});
}
  }
...
if (val_truthy(runtime_binop(40, runtime_binop(53, runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "TOK_NEWLINE")), runtime_var_get(env, "k")), runtime_var_get(env, "TOK_SEMICOLON")))) {
  ...
  runtime_call(table_get(env, "nd_push"), env, 2, (Value*[]){runtime_var_get(env, "prog"), runtime_call(table_get(env, "parse_stmt"), env, 1, (Value*[]){runtime_var_get(env, "p")})});
runtime_call(table_get(env, "skip_newlines"), env, 1, (Value*[]){runtime_var_get(env, "p")});
}
  }
  return val_out(runtime_var_get(env, "prog"));
...
if (val_truthy(runtime_binop(48, runtime_var_get(env, "depth"), val_num(100)))) {
  val_str("Runtime error: circular reference in unwrap");
exit((int)(val_num(1))->num);
}
  }
...
if (val_truthy(runtime_binop(51, runtime_type(runtime_var_get(env, "existing")), val_str("none")))) {
  runtime_str_concat(runtime_tostr(val_str("Runtime error: cannot reassign constant "))->str, runtime_tostr(runtime_var_get(env, "name"))->str);
exit((int)(val_num(1))->num);
}
  }
...
runtime_binop(41, runtime_binop(41, runtime_binop(41, runtime_binop(41, runtime_str_concat(runtime_tostr(val_str("Runtime error: undefined variable "))->str, runtime_tostr(runtime_at(runtime_var_get(env, "n"), val_str("name")))->str), val_str(" in ")), runtime_at(runtime_var_get(env, "n"), val_str("filename"))), val_str(" on line ")), runtime_tostr(runtime_at(runtime_var_get(env, "n"), val_str("line"))));
exit((int)(val_num(1))->num);
}
return val_out(runtime_var_get(env, "res"));
  }
...
if (val_truthy(runtime_binop(40, runtime_at(runtime_var_get(env, "left"), val_str("kind")), runtime_var_get(env, "ND_VAR")))) {
  runtime_call(table_get(env, "table_set"), env, 3, (Value*[]){runtime_var_get(env, "env_"), runtime_at(runtime_var_get(env, "left"), val_str("name")), runtime_call(table_get(env, "val_unwrap"), env, 1, (Value*[]){runtime_var_get(env, "val")})});
} else {
...
if (val_truthy(runtime_binop(40, runtime_at(runtime_var_get(env, "target"), val_str("kind")), runtime_var_get(env, "VAL_LIST")))) {
  ...
  val_str("Runtime error: dict key must be string");
exit((int)(val_num(1))->num);
}
...
table_set(env, "i", val_num(0));
while (val_truthy(runtime_binop(47, runtime_var_get(env, "i"), runtime_len(runtime_var_get(env, "items"))))) {
  runtime_call(table_get(env, "table_set"), env, 3, (Value*[]){runtime_var_get(env, "env_"), runtime_at(runtime_var_get(env, "n"), val_str("name")), runtime_at(runtime_var_get(env, "items"), runtime_var_get(env, "i"))});
table_set(env, "res", runtime_call(table_get(env, "eval_block"), env, 2, (Value*[]){runtime_at(runtime_at(runtime_var_get(env, "n"), val_str("body")), val_num(0)), runtime_var_get(env, "env_")}));
if (val_truthy(runtime_binop(40, runtime_at(runtime_var_get(env, "res"), val_str("kind")), runtime_var_get(env, "VAL_BREAK")))) {
  break;
}
...
if (val_truthy(runtime_binop(40, runtime_type(runtime_var_get(env, "fn")), val_str("none")))) {
  runtime_binop(41, runtime_binop(41, runtime_binop(41, runtime_binop(41, runtime_str_concat(runtime_tostr(val_str("Runtime error: undefined function "))->str, runtime_tostr(runtime_at(runtime_at(runtime_var_get(env, "n"), val_str("left")), val_str("name")))->str), val_str(" in ")), runtime_at(runtime_var_get(env, "n"), val_str("filename"))), val_str(" on line ")), runtime_tostr(runtime_at(runtime_var_get(env, "n"), val_str("line"))));
exit((int)(val_num(1))->num);
}
...
runtime_call(table_get(env, "table_set"), env, 3, (Value*[]){runtime_var_get(env, "scope"), runtime_at(runtime_at(runtime_var_get(env, "params"), runtime_var_get(env, "i")), val_str("name")), runtime_var_get(env, "val")});
table_set(env, "i", runtime_binop(41, runtime_var_get(env, "i"), val_num(1)));
}
table_set(env, "res", runtime_call(table_get(env, "eval_block"), env, 2, (Value*[]){runtime_at(runtime_var_get(env, "fn"), val_str("left")), runtime_var_get(env, "scope")}));
if (val_truthy(runtime_binop(40, runtime_at(runtime_var_get(env, "res"), val_str("kind")), runtime_var_get(env, "VAL_OUT")))) {
...
static Value* io_func_emit_runtime(Table* parent, int argc, Value** argv) {
  Table* env = table_new(parent);
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("#include <stdio.h>")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("#include <stdlib.h>")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("#include <stdint.h>")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("#include <string.h>")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("#include <stdbool.h>")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("#include <math.h>")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("#include <time.h>")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("#include <ctype.h>")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("typedef enum { VAL_NUM, VAL_STR, VAL_LIST, VAL_DICT, VAL_FUNC, VAL_BIT, VAL_REF, VAL_BREAK, VAL_SKIP, VAL_OUT, VAL_NONE } ValKind;")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("struct Table;")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("struct Value;")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("typedef struct Value* (*IoFunc)(struct Table*, int, struct Value**);")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("typedef struct Value { ValKind kind; double num; char *str; struct Value **items; int item_count; int item_cap; struct Table *fields; IoFunc func; struct Value *target; struct Value *inner; } Value;")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("typedef struct Entry { char *key; Value *val; bool is_constant; struct Entry *next; } Entry;")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("typedef struct Table { Entry *buckets[256]; struct Table *parent; } Table;")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("static unsigned hash(const char *s) { unsigned h = 0; while(*s) h = h * 31 + (unsigned char)*s++; return h % 256; }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("static Table* table_new(Table *p) { Table *t = calloc(1, sizeof(Table)); t->parent = p; return t; }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("static Value *val_num(double n) { Value *v = calloc(1, sizeof(Value)); v->kind = VAL_NUM; v->num = n; return v; }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("static Value *val_str(const char *s) { Value *v = calloc(1, sizeof(Value)); v->kind = VAL_STR; v->str = strdup(s); return v; }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("static Value *val_list() { Value *v = calloc(1, sizeof(Value)); v->kind = VAL_LIST; v->item_cap = 8; v->items = calloc(8, sizeof(Value*)); return v; }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("static Value *val_dict() { Value *v = calloc(1, sizeof(Value)); v->kind = VAL_DICT; v->fields = table_new(NULL); return v; }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("static Value *val_func(IoFunc f) { Value *v = calloc(1, sizeof(Value)); v->kind = VAL_FUNC; v->func = f; return v; }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("static Value *val_bit(bool b) { Value *v = calloc(1, sizeof(Value)); v->kind = VAL_BIT; v->num = b ? 1 : 0; return v; }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("static Value *val_ref(Value *t) { Value *v = calloc(1, sizeof(Value)); v->kind = VAL_REF; v->target = t; return v; }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("static Value *val_out(Value *i) { Value *v = calloc(1, sizeof(Value)); v->kind = VAL_OUT; v->inner = i; return v; }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("static Value *val_none() { Value *v = calloc(1, sizeof(Value)); v->kind = VAL_NONE; return v; }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("static Value* table_get(Table *t, const char *k) { for(Table *cur=t;cur;cur=cur->parent){ unsigned h=hash(k); for(Entry *e=cur->buckets[h];e;e=e->next) if(!strcmp(e->key,k)) return e->val; } return val_none(); }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("static bool is_all_caps(const char *s) { if(!s||!*s)return false; bool h=false; for(const char *c=s;*c;c++){ if(*c>='a'&&*c<='z') return false; if(*c>='A'&&*c<='Z') h=true; } return h; }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("static void table_set(Table *t, const char *k, Value *v) { unsigned h = hash(k); for(Entry *e=t->buckets[h];e;e=e->next) if(!strcmp(e->key,k)){ if(e->is_constant){fprintf(stderr,\"Runtime error: cannot reassign constant '%s'\\n\",k);exit(1);} if(e->val->kind == VAL_REF) { Value *trg = e->val->target; trg->kind=v->kind; trg->num=v->num; trg->str=v->str; trg->items=v->items; trg->item_count=v->item_count; trg->fields=v->fields; return; } e->val=v;return;} Entry *en=malloc(sizeof(Entry)); en->key=strdup(k); en->val=v; en->is_constant=is_all_caps(k); en->next=t->buckets[h]; t->buckets[h]=en; }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("static Value* val_unwrap(Value* v) { while(v && (v->kind == VAL_REF || v->kind == VAL_OUT)) v = (v->kind == VAL_REF ? v->target : v->inner); return v; }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("static bool val_truthy(Value *v) { v = val_unwrap(v); if(!v) return false; if(v->kind==VAL_NUM) return v->num != 0; if(v->kind==VAL_STR) return v->str[0]!='\\0'; if(v->kind==VAL_LIST||v->kind==VAL_DICT) return v->item_count > 0 || (v->kind==VAL_DICT && v->fields); if(v->kind==VAL_BIT) return v->num != 0; return false; }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("static Value* val_print(Value *v) { v = val_unwrap(v); if(!v) return val_none(); if(v->kind==VAL_NUM) printf(v->num==(long long)v->num?\"%lld\":\"%g\",(long long)v->num); else if(v->kind==VAL_STR) printf(\"%s\",v->str); else if(v->kind==VAL_LIST){ printf(\"[\"); for(int i=0;i<v->item_count;i++){ if(i)printf(\", \"); val_print(v->items[i]); } printf(\"]\"); } else if(v->kind==VAL_DICT){ printf(\"{\"); bool f=1; for(int i=0;i<256;i++) for(Entry *e=v->fields->buckets[i];e;e=e->next){ if(!f)printf(\", \"); printf(\"%s: \", e->key); val_print(e->val); f=0; } printf(\"}\"); } else if(v->kind==VAL_FUNC) printf(\"<func>\"); else if(v->kind==VAL_BIT) printf(\"%lld\",(long long)v->num); fflush(stdout); return v; }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("static Value* runtime_binop(int op, Value* l, Value* r) {")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("  l = val_unwrap(l); r = val_unwrap(r);")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("  if(op==0 && (l->kind==VAL_STR||r->kind==VAL_STR)){ char b[2048]; sprintf(b, \"%s%s\", l->kind==VAL_STR?l->str:\"\", r->kind==VAL_STR?r->str:\"\"); return val_str(b); }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("  if(l->kind==VAL_STR && r->kind==VAL_STR) {")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("    int c=strcmp(l->str,r->str); switch(op){")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("      case 17: return val_bit(c==0); case 18: return val_bit(c!=0);")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("      case 19: return val_bit(c<0); case 20: return val_bit(c>0); case 21: return val_bit(c<=0); case 22: return val_bit(c>=0);")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("    }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("  }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("  double a=l->num, b=r->num; switch(op){")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("    case 0: return val_num(a+b); case 1: return val_num(a-b); case 2: return val_num(a*b); case 3: return val_num(b?a/b:0); case 4: return val_num(b?fmod(a,b):0);")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("    case 19: return val_bit(a<b); case 20: return val_bit(a>b); case 21: return val_bit(a<=b); case 22: return val_bit(a>=b); case 18: return val_bit(a!=b); case 17: return val_bit(a==b); case 27: return val_bit(val_truthy(l)&&val_truthy(r)); case 28: return val_bit(val_truthy(l)||val_truthy(r)); default: return val_none();")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("  }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("}")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("static Value* runtime_call(Value* f, Table* e, int c, Value** v) { if(f->kind==VAL_FUNC) return f->func(e, c, v); return val_none(); }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("static Value* runtime_var_get(Table* e, const char* k) { Value* v=table_get(e,k); if(v->kind==VAL_FUNC) return v->func(e,0,NULL); return v; }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("static Value* runtime_at(Value* l, Value* r) { l = val_unwrap(l); r = val_unwrap(r); if(l->kind==VAL_DICT) return table_get(l->fields, r->str); int i=(int)r->num; if(l->kind==VAL_STR){ int len=strlen(l->str); if(i<0)i+=len; if(i<0||i>=len) return val_none(); char b[2]={l->str[i],0}; return val_str(b); } if(l->kind==VAL_LIST){ if(i<0)i+=l->item_count; if(i<0||i>=l->item_count) return val_none(); return l->items[i]; } return val_none(); }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("static Value* runtime_set(Value* l, Value* i, Value* v) { l = val_unwrap(l); i = val_unwrap(i); if(l->kind!=VAL_LIST) return v; int idx=(int)i->num; if(idx==l->item_count){ if(l->item_count>=l->item_cap){ l->item_cap*=2; l->items=realloc(l->items,l->item_cap*sizeof(Value*)); } l->items[l->item_count++]=v; } else if(idx>=0 && idx<l->item_count) l->items[idx]=v; return v; }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("static Value* runtime_key(Value* d, Value* k, Value* v) { d = val_unwrap(d); k = val_unwrap(k); if(d->kind==VAL_DICT) table_set(d->fields, k->str, v); return v; }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("static Value* runtime_keys(Value* v) { v = val_unwrap(v); if(v->kind!=VAL_DICT) return val_list(); Value* r=val_list(); for(int i=0;i<256;i++) for(Entry *e=v->fields->buckets[i];e;e=e->next){ if(r->item_count>=r->item_cap){r->item_cap*=2;r->items=realloc(r->items,r->item_cap*sizeof(Value*));} r->items[r->item_count++]=val_str(e->key); } return r; }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("static Value* runtime_ask(Value* p) { p = val_unwrap(p); if(p&&p->kind==VAL_STR){ FILE* f=fopen(p->str,\"rb\"); if(!f){ fprintf(stderr,\"Error: cannot open file '%s'\\n\",p->str); return val_str(\"\"); } fseek(f,0,SEEK_END); long l=ftell(f); fseek(f,0,SEEK_SET); char* b=malloc(l+1); fread(b,1,l,f); b[l]=0; fclose(f); Value* v=val_str(b); free(b); return v; } char buf[1024]; if(!fgets(buf,1024,stdin)) return val_str(\"\"); buf[strcspn(buf,\"\\n\")]=0; return val_str(buf); }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("static Value* runtime_len(Value* v) { v = val_unwrap(v); if(v->kind==VAL_STR) return val_num(strlen(v->str)); if(v->kind==VAL_LIST) return val_num(v->item_count); if(v->kind==VAL_DICT){ int c=0; for(int i=0;i<256;i++) for(Entry *e=v->fields->buckets[i];e;e=e->next) c++; return val_num(c); } return val_num(0); }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("static Value* runtime_ord(Value* v) { v = val_unwrap(v); if(v->kind==VAL_STR&&v->str[0]) return val_num((unsigned char)v->str[0]); return val_num(0); }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("static Value* runtime_chr(Value* v) { v = val_unwrap(v); char b[2]={v->num,0}; return val_str(b); }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("static Value* runtime_tonum(Value* v) { v = val_unwrap(v); if(v->kind==VAL_STR){ char*e; double d=strtod(v->str,&e); return val_num(*e==0&&e!=v->str?d:0); } if(v->kind==VAL_NUM) return v; return val_num(0); }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("static Value* runtime_tostr(Value* v) { v = val_unwrap(v); char b[64]; if(v->kind==VAL_NUM){ if(v->num==(long long)v->num) snprintf(b,64,\"%lld\",(long long)v->num); else snprintf(b,64,\"%g\",v->num); return val_str(b); } if(v->kind==VAL_STR) return v; return val_str(\"\"); }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("static Value* runtime_slice(Value* v, Value* sv, Value* ev) { v = val_unwrap(v); sv = val_unwrap(sv); ev = val_unwrap(ev); int s=(int)sv->num, e=(int)ev->num; if(v->kind==VAL_STR){ int l=strlen(v->str); if(s<0)s+=l; if(e<0)e+=l; if(s<0)s=0; if(e>l)e=l; if(s>=e)return val_str(\"\"); int n=e-s; char *b=malloc(n+1); memcpy(b,v->str+s,n); b[n]=0; Value *res=val_str(b); free(b); return res; } if(v->kind==VAL_LIST){ int l=v->item_count; if(s<0)s+=l; if(e<0)e+=l; if(s<0)s=0; if(e>l)e=l; Value *res=val_list(); if(s>=e)return res; for(int i=s;i<e;i++){ if(res->item_count>=res->item_cap){ res->item_cap*=2; res->items=realloc(res->items,res->item_cap*sizeof(Value*)); } res->items[res->item_count++]=v->items[i]; } return res; } return val_none(); }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("static Value* runtime_type(Value* v) { v = val_unwrap(v); switch(v->kind){ case VAL_NUM: return val_str(\"num\"); case VAL_STR: return val_str(\"str\"); case VAL_LIST: return val_str(\"list\"); case VAL_DICT: return val_str(\"dict\"); case VAL_BIT: return val_str(\"bit\"); default: return val_str(\"none\"); } }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("static Value* runtime_sys(Value* v) { v = val_unwrap(v); if(v->kind!=VAL_STR) return val_num(-1); return val_num((double)system(v->str)); }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("static Value* runtime_split(Value* s, Value* d) { char *st = strdup(s->str); Value *res = val_list(); char *t = strtok(st, d->str); while(t){ if(res->item_count>=res->item_cap){ res->item_cap*=2; res->items=realloc(res->items, res->item_cap*sizeof(Value*)); } res->items[res->item_count++]=val_str(t); t=strtok(NULL, d->str); } free(st); return res; }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("static Value* runtime_trim(Value* v) { char *s = v->str; while(isspace(*s)) s++; if(!*s) return val_str(\"\"); char *e = s+strlen(s)-1; while(e>s && isspace(*e)) e--; *(e+1)=0; return val_str(s); }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("static Value* runtime_replace(Value* v, Value* t, Value* r) { char b[4096]={0}; char *p=v->str; char *o=b; size_t tl=strlen(t->str); while(*p){ char *f=strstr(p,t->str); if(f==p){ strcpy(o,r->str); o+=strlen(r->str); p+=tl; } else *o++=*p++; } return val_str(b); }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("static Value* runtime_safe(Value* v) { return v; }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("static Value* runtime_env(Value* v) { v = val_unwrap(v); if(v->kind!=VAL_STR) return val_str(\"\"); char* e=getenv(v->str); return e?val_str(e):val_str(\"\"); }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("static Value* io_val_print(Table* t, int argc, Value** argv) { if(argc > 0) { val_print(argv[0]); printf(\"\\n\"); fflush(stdout); return argv[0]; } return val_none(); }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("static Value* io_val_unwrap(Table* t, int argc, Value** argv) { if(argc > 0) return val_unwrap(argv[0]); return val_none(); }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("static Value* io_table_new(Table* t, int argc, Value** argv) { Value *v = val_dict(); if(argc > 0) { Value *p = val_unwrap(argv[0]); if(p->kind == VAL_DICT) v->fields->parent = p->fields; } return v; }")});
  return val_out(runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("")}));
  return val_none();
}
...
runtime_call(table_get(env, "hoist_vars"), env, 1, (Value*[]){runtime_at(runtime_var_get(env, "node"), val_str("right"))});
  } else {
    if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "ND_BINOP")))) {
      runtime_call(table_get(env, "hoist_vars"), env, 1, (Value*[]){runtime_at(runtime_var_get(env, "node"), val_str("left"))});
runtime_call(table_get(env, "hoist_vars"), env, 1, (Value*[]){runtime_at(runtime_var_get(env, "node"), val_str("right"))});
    } else {
      if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "ND_IF")))) {
        runtime_call(table_get(env, "hoist_vars"), env, 1, (Value*[]){runtime_at(runtime_var_get(env, "node"), val_str("left"))});
...
if (val_truthy(runtime_binop(48, runtime_len(runtime_var_get(env, "body")), val_num(0)))) {
  runtime_call(table_get(env, "hoist_vars"), env, 1, (Value*[]){runtime_at(runtime_var_get(env, "body"), val_num(0))});
}
...
table_set(env, "i", val_num(0));
while (val_truthy(runtime_binop(47, runtime_var_get(env, "i"), runtime_len(runtime_var_get(env, "body"))))) {
  runtime_call(table_get(env, "hoist_vars"), env, 1, (Value*[]){runtime_at(runtime_var_get(env, "body"), runtime_var_get(env, "i"))});
table_set(env, "i", runtime_binop(41, runtime_var_get(env, "i"), val_num(1)));
}
          } else {
...
runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("({ Value* _res = val_none(); ")});
table_set(env, "indent_lvl", val_num(1));
runtime_call(table_get(env, "emit_stmt"), env, 1, (Value*[]){runtime_var_get(env, "n")});
runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("_res; ")});
runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("})")});
...
while (val_truthy(runtime_binop(47, runtime_var_get(env, "i"), runtime_len(runtime_var_get(env, "body"))))) {
  ...
  runtime_binop(41, runtime_binop(41, runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("_res = ")}), runtime_call(table_get(env, "emit_expr"), env, 1, (Value*[]){runtime_at(runtime_var_get(env, "body"), runtime_var_get(env, "i"))})), val_str(";"));
} else {
  runtime_call(table_get(env, "emit_stmt"), env, 1, (Value*[]){runtime_at(runtime_var_get(env, "body"), runtime_var_get(env, "i"))});
}
table_set(env, "i", runtime_binop(41, runtime_var_get(env, "i"), val_num(1)));
}
  } else {
    if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "ND_ASSIGN")))) {
      table_set(env, "left", runtime_at(runtime_var_get(env, "n"), val_str("left")));
runtime_binop(41, runtime_binop(41, runtime_binop(41, runtime_call(table_get(env, "emit"), env, 1, (Value*[]){runtime_at(runtime_var_get(env, "left"), val_str("name"))}), val_str(" = ")), runtime_call(table_get(env, "emit_expr"), env, 1, (Value*[]){runtime_at(runtime_var_get(env, "n"), val_str("right"))})), val_str(";"));
    } else {
      if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "ND_IF")))) {
        runtime_binop(41, runtime_binop(41, runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("if (val_truthy(")}), runtime_call(table_get(env, "emit_expr"), env, 1, (Value*[]){runtime_at(runtime_var_get(env, "n"), val_str("left"))})), val_str(")) {"));
table_set(env, "indent_lvl", runtime_binop(41, runtime_var_get(env, "indent_lvl"), val_num(1)));
runtime_call(table_get(env, "emit_stmt"), env, 1, (Value*[]){runtime_at(runtime_at(runtime_var_get(env, "n"), val_str("body")), val_num(0))});
table_set(env, "indent_lvl", runtime_binop(42, runtime_var_get(env, "indent_lvl"), val_num(1)));
runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("}")});
if (val_truthy(runtime_binop(51, runtime_type(runtime_at(runtime_var_get(env, "n"), val_str("right"))), val_str("none")))) {
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("else {")});
table_set(env, "indent_lvl", runtime_binop(41, runtime_var_get(env, "indent_lvl"), val_num(1)));
runtime_call(table_get(env, "emit_stmt"), env, 1, (Value*[]){runtime_at(runtime_var_get(env, "n"), val_str("right"))});
table_set(env, "indent_lvl", runtime_binop(42, runtime_var_get(env, "indent_lvl"), val_num(1)));
runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("}")});
}
      } else {
        if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "ND_WHILE")))) {
          runtime_binop(41, runtime_binop(41, runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("while (val_truthy(")}), runtime_call(table_get(env, "emit_expr"), env, 1, (Value*[]){runtime_at(runtime_var_get(env, "n"), val_str("left"))})), val_str(")) {"));
table_set(env, "indent_lvl", runtime_binop(41, runtime_var_get(env, "indent_lvl"), val_num(1)));
runtime_call(table_get(env, "emit_stmt"), env, 1, (Value*[]){runtime_at(runtime_at(runtime_var_get(env, "n"), val_str("body")), val_num(0))});
table_set(env, "indent_lvl", runtime_binop(42, runtime_var_get(env, "indent_lvl"), val_num(1)));
runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("}")});
          ...
          if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "ND_FOR")))) {
            runtime_binop(41, runtime_binop(41, runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("{ Value* _lst = val_unwrap(")}), runtime_call(table_get(env, "emit_expr"), env, 1, (Value*[]){runtime_at(runtime_var_get(env, "n"), val_str("left"))})), val_str(");"));
runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("  for (int _i = 0; _i < _lst->item_count; _i++) {")});
runtime_binop(41, runtime_binop(41, runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("    table_set(env, \"")}), runtime_at(runtime_var_get(env, "n"), val_str("name"))), val_str("\", _lst->items[_i]);"));
runtime_call(table_get(env, "emit_stmt"), env, 1, (Value*[]){runtime_at(runtime_at(runtime_var_get(env, "n"), val_str("body")), val_num(0))});
runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("  }}")});
          } else {
            if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "ND_BREAK")))) {
              runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("break;")});
            } else {
              if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "ND_SKIP")))) {
                runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("continue;")});
              } else {
                if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "ND_PRINT")))) {
                  runtime_binop(41, runtime_binop(41, runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("val_print(")}), runtime_call(table_get(env, "emit_expr"), env, 1, (Value*[]){runtime_at(runtime_var_get(env, "n"), val_str("left"))})), val_str("); printf(\"\\n\");"));
                } else {
                  if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "ND_OUT")))) {
                    runtime_binop(41, runtime_binop(41, runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("return ")}), runtime_call(table_get(env, "emit_expr"), env, 1, (Value*[]){runtime_at(runtime_var_get(env, "n"), val_str("left"))})), val_str(";"));
                  } else {
                    if (val_truthy(runtime_binop(40, runtime_var_get(env, "k"), runtime_var_get(env, "ND_DO")))) {
...
runtime_call(table_get(env, "hoist_vars"), env, 1, (Value*[]){runtime_at(runtime_var_get(env, "n"), val_str("left"))});
runtime_binop(41, runtime_binop(41, runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("Value* ")}), runtime_at(runtime_var_get(env, "n"), val_str("name"))), val_str("() {"));
table_set(env, "indent_lvl", runtime_binop(41, runtime_var_get(env, "indent_lvl"), val_num(1)));
...
if (val_truthy(runtime_binop(40, runtime_var_get(env, "is_param"), val_num(0)))) {
  runtime_binop(41, runtime_binop(41, runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("Value* ")}), runtime_at(runtime_var_get(env, "vnames"), runtime_var_get(env, "i"))), val_str(" = val_none();"));
}
table_set(env, "i", runtime_binop(41, runtime_var_get(env, "i"), val_num(1)));
}
runtime_call(table_get(env, "emit_stmt"), env, 1, (Value*[]){runtime_at(runtime_var_get(env, "n"), val_str("left"))});
table_set(env, "indent_lvl", runtime_binop(42, runtime_var_get(env, "indent_lvl"), val_num(1)));
runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("}")});
...
table_set(env, "i", runtime_binop(41, runtime_var_get(env, "i"), val_num(1)));
  ...
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("int main(int argc, char** argv) {")});
  table_set(env, "indent_lvl", runtime_binop(41, runtime_var_get(env, "indent_lvl"), val_num(1)));
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("global_arena = arena_create(512*1024*1024);")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("Value* arg = val_list();")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("for (int i = 1; i < argc; i++) {")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("  if (arg->item_count >= arg->item_cap) {")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("    arg->item_cap *= 2;")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("    arg->items = realloc(arg->items, arg->item_cap * sizeof(Value*));")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("  }")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("  arg->items[arg->item_count++] = val_str(argv[i]);")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("}")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("Table* env = table_new(NULL);")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("table_set(env, \"arg\", arg);")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("Value** args = malloc(arg->item_count * sizeof(Value*));")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("for (int i = 0; i < arg->item_count; i++) args[i] = arg->items[i];")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("Value* result = io_func_main(env, arg->item_count, args);")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("if (result->kind != VAL_NONE && result->kind != VAL_BREAK) {")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("  val_print(result);")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("  printf(\"\\n\");")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("}")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("free(args);")});
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("return 0;")});
  table_set(env, "indent_lvl", runtime_binop(42, runtime_var_get(env, "indent_lvl"), val_num(1)));
  runtime_call(table_get(env, "emit"), env, 1, (Value*[]){val_str("}")});
...
static Value* io_func_compile_to_bin(Table* parent, int argc, Value** argv) {
  ...
  runtime_binop(41, runtime_str_concat(runtime_tostr(val_str("Compiling "))->str, runtime_tostr(runtime_var_get(env, "out_name"))->str), val_str("..."));
  runtime_sys(runtime_var_get(env, "cmd"));
...
static Value* io_func_print_usage(Table* parent, int argc, Value** argv) {
  Table* env = table_new(parent);
  runtime_put(val_str(""), val_str("vii - a minimalist programming language\n"), 0);
  runtime_put(val_str(""), val_str("Usage: vii <file.vii> [-o program] [args...]\n"), 0);
  runtime_put(val_str(""), val_str("       vii --version\n"), 0);
  runtime_put(val_str(""), val_str("       vii --help\n"), 0);
  runtime_put(val_str(""), val_str("       vii --debug <file.vii>\n"), 0);
  runtime_put(val_str(""), val_str("\n"), 0);
  runtime_put(val_str(""), val_str("Options:\n"), 0);
  runtime_put(val_str(""), val_str("  -o <name>      Compile to executable\n"), 0);
  runtime_put(val_str(""), val_str("  -k, --keep     Keep transpiled .c source\n"), 0);
  runtime_put(val_str(""), val_str("  -D <name>      Define compile-time flag for IF macros\n"), 0);
  exit((int)(val_num(1))->num);
  return val_none();
}
...
static Value* io_func_main(Table* parent, int argc, Value** argv) {
  ...
  table_set(env, "implicit_print", val_num(0));
  table_set(env, "target_set", val_num(0));
...
if (val_truthy(runtime_binop(40, runtime_var_get(env, "current_arg"), val_str("--debug")))) {
  ...
  if (val_truthy(runtime_binop(40, runtime_var_get(env, "current_arg"), val_str("--bootdebug")))) {
    ...
    if (val_truthy(runtime_binop(40, runtime_var_get(env, "current_arg"), val_str("--trace")))) {
      table_set(env, "trace", val_num(1));
    } else {
...
table_set(env, "i", runtime_var_get(env, "next_i"));
  ...
  runtime_binop(41, runtime_binop(41, runtime_var_get(env, "color_red"), val_str("Error: -o requires a filename")), runtime_var_get(env, "color_rst"));
exit((int)(val_num(1))->num);
}
      } else {
        if (val_truthy(runtime_binop(40, runtime_var_get(env, "current_arg"), val_str("-k")))) {
          ...
          if (val_truthy(runtime_binop(40, runtime_var_get(env, "current_arg"), val_str("--keep")))) {
            ...
            if (val_truthy(runtime_binop(40, runtime_var_get(env, "current_arg"), val_str("-D")))) {
              table_set(env, "next_i", runtime_binop(41, runtime_var_get(env, "i"), val_num(1)));
if (val_truthy(runtime_binop(47, runtime_var_get(env, "next_i"), runtime_var_get(env, "argc")))) {
  runtime_at(runtime_call(table_get(env, "add_define"), env, 1, (Value*[]){io_args}), runtime_var_get(env, "next_i"));
table_set(env, "i", runtime_var_get(env, "next_i"));
} else {
  runtime_binop(41, runtime_binop(41, runtime_var_get(env, "color_red"), val_str("Error: -D requires a name")), runtime_var_get(env, "color_rst"));
exit((int)(val_num(1))->num);
}
            } else {
...
exit((int)(val_num(1))->num);
                ...
                if (val_truthy(runtime_binop(40, runtime_var_get(env, "current_arg"), val_str("--version")))) {
                  runtime_put(val_str(""), val_str("vii 2.0.0 bootstrapped\n"), 0);
...
if (val_truthy(runtime_binop(40, runtime_var_get(env, "first_char"), val_str("-")))) {
  runtime_put(val_str(""), runtime_binop(41, runtime_str_concat(runtime_tostr(val_str("Warning: Ignoring unknown flag: "))->str, runtime_tostr(runtime_var_get(env, "current_arg"))->str), val_str("\n")), 0);
} else {
  if (val_truthy(runtime_binop(40, runtime_var_get(env, "input_path"), val_str("none")))) {
    ...
    runtime_put(val_str(""), runtime_binop(41, runtime_str_concat(runtime_tostr(val_str("Warning: Ignoring unknown positional argument: "))->str, runtime_tostr(runtime_var_get(env, "current_arg"))->str), val_str("\n")), 0);
  }
}
                        }
                      }
...
table_set(env, "i", runtime_binop(41, runtime_var_get(env, "i"), val_num(1)));
  ...
  if (val_truthy(runtime_var_get(env, "trace"))) {
    runtime_str_concat(runtime_tostr(val_str("[TRACE] Reading file: "))->str, runtime_tostr(runtime_var_get(env, "input_path"))->str);
  }
  ...
  runtime_key(runtime_var_get(env, "lexer"), val_str("trace"), runtime_var_get(env, "trace"));
  ...
  if (val_truthy(runtime_var_get(env, "trace"))) {
    val_str("[TRACE] Starting lexer...");
  }
  table_set(env, "tokens", runtime_call(table_get(env, "lex"), env, 1, (Value*[]){runtime_var_get(env, "lexer")}));
  if (val_truthy(runtime_var_get(env, "trace"))) {
    runtime_binop(41, runtime_str_concat(runtime_tostr(val_str("[TRACE] Lexed "))->str, runtime_tostr(runtime_tostr(runtime_len(runtime_var_get(env, "tokens"))))->str), val_str(" tokens"));
  }
  ...
  runtime_key(runtime_var_get(env, "parser"), val_str("trace"), runtime_var_get(env, "trace"));
  ...
  if (val_truthy(runtime_var_get(env, "trace"))) {
    val_str("[TRACE] Starting parser...");
  }
  table_set(env, "prog", runtime_call(table_get(env, "parse_program"), env, 1, (Value*[]){runtime_var_get(env, "parser")}));
  if (val_truthy(runtime_var_get(env, "trace"))) {
    val_str("[TRACE] Parsed AST");
  }
  if (val_truthy(runtime_var_get(env, "debug_ast"))) {
    val_str("AST debug output not yet implemented in Vii main.vii");
val_str("AST would be dumped to debug_ast.json");
  }
  if (val_truthy(runtime_binop(51, runtime_var_get(env, "output_name"), val_str("none")))) {
    if (val_truthy(runtime_var_get(env, "trace"))) {
  runtime_str_concat(runtime_tostr(val_str("[TRACE] Compiling to binary: "))->str, runtime_tostr(runtime_var_get(env, "output_name"))->str);
}
runtime_call(table_get(env, "compile_to_bin"), env, 3, (Value*[]){runtime_var_get(env, "prog"), runtime_var_get(env, "output_name"), runtime_var_get(env, "keep_c")});
exit((int)(val_num(0))->num);
  }
  ...
  if (val_truthy(runtime_var_get(env, "trace"))) {
    val_str("[TRACE] Starting interpreter...");
  }
  table_set(env, "res", runtime_call(table_get(env, "val_unwrap"), env, 1, (Value*[]){runtime_call(table_get(env, "eval"), env, 2, (Value*[]){runtime_var_get(env, "prog"), runtime_var_get(env, "global_table")})}));
  if (val_truthy(runtime_var_get(env, "trace"))) {
    val_str("[TRACE] Interpreter returned");
  }
  if (val_truthy(runtime_binop(51, runtime_binop(52, runtime_binop(51, runtime_at(runtime_var_get(env, "res"), val_str("kind")), runtime_var_get(env, "VAL_NONE")), runtime_at(runtime_var_get(env, "res"), val_str("kind"))), runtime_var_get(env, "VAL_BREAK")))) {
    runtime_call(table_get(env, "val_print"), env, 1, (Value*[]){runtime_var_get(env, "res")});
  }
  exit((int)(val_num(0))->num);
  return val_none();
}
...
int main(int argc, char **argv) {
  ...
  table_set(env, "emit_runtime", val_func(io_func_emit_runtime));
  ...
  Value** args = malloc(io_args->item_count * sizeof(Value*));
  for (int i = 0; i < io_args->item_count; i++) args[i] = io_args->items[i];
  Value *program_result = io_func_main(env, io_args->item_count, args);
